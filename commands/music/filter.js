module.exports = {
    ...
    execute(client, message, args) {
        ...
        if (filtersUpdated[filterToUpdate]) message.channel.send(`${client.emotes.music} - **applying** the filter to the music, please wait... Note : the longer the music is, the longer this will take.`);
